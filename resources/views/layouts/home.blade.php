            ...
            <div class="hero__content">
                ...
                <div class="hero__visual animate-scale-in delay-200">
                    <div class="hero__visual-inner">
                        ...
                        {{-- Floating chip — top --}}
                        <div class="hero__chip hero__chip--top animate-float">
                            <span class="hero__chip-emoji" aria-hidden="true">🏆</span>
                            <div>
                                <p class="hero__chip-label">Top School</p>
                                <p class="hero__chip-sub">2024 Award</p>
                            </div>
                        </div>

                        {{-- Main dark card --}}
                        <div class="hero__card-main">
                            <div class="hero__school-emblem animate-float-slow">
                            ...
                            <p class="hero__card-school">Taboc Elementary</p>
                            <p class="hero__card-type">DepEd — Public Elementary School</p>
                            ...
                            <div class="hero__card-row">
                                ...
                                <div>
                                    <p class="hero__card-info-label">School Year</p>
                                    <p class="hero__card-info-value">2025 – 2026</p>
                                </div>
                            </div>
                            ...
                            <div class="hero__card-row">
                                ...
                                <div>
                                    <p class="hero__card-info-label">Class Hours</p>
                                    <p class="hero__card-info-value">7:30 AM – 5:00 PM, Mon–Fri</p>
                                </div>
                            </div>
                            ...
                            <div class="hero__card-row">
                                ...
                                <div>
                                    <p class="hero__card-info-label">Location</p>
                                    <p class="hero__card-info-value">Taboc, Philippines</p>
                                </div>
                            </div>
                        </div>

                        {{-- Floating chip — bottom --}}
                        <div class="hero__chip hero__chip--bottom animate-float" style="animation-delay:1.2s;">
                            <span class="hero__chip-emoji" aria-hidden="true">⭐</span>
                            <div>
                                <p class="hero__chip-label">4.9 Community</p>
                                <p class="hero__chip-sub">Rating Score</p>
                            </div>
                        </div>
